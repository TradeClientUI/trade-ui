    ...
    <div class='privacyPolicy'>
        <div class='content'>
            ...
            <div class='content_section'>
                ...
                <p class='text'>
                    Where MagnaMarkets holds customer’s personal data, customer agrees that MagnaMarkets (subject to the provisions of this Policy) may use such personal data for the following purposes:
                </p>
            </div>
            <div class='content_section'>
                <p class='text'>
                    1.The personal information collected by MagnaMarkets is only used by MagnaMarkets for business operations and other related activities;
                </p>
                <p class='li'>
                    2.MagnaMarkets is committed to ensuring that its website is safe and in line with industry standards, and uses other data protection tools, such as: firewalls, authentication systems (passwords and personal ID numbers, etc.) and manipulation mechanisms to restrict unauthorized systems from entering the website and accessing data;
                </p>
                <p class='li'>
                    3.MagnaMarkets will keep customers' personal information confidential and protect customers' personal information from being stolen. MagnaMarkets employees will also respect customers' privacy and will never disclose any information to unauthorized persons;
                </p>
                <p class='li'>
                    4.Customers can check and change their personal data kept by MagnaMarkets from time to time;
                </p>
                <p class='li'>
