    ...
    <div class='actives'>
        ...
        <div class='cont_bg'>
            <div class='cont'>
                ...
                <div class='welcome'>
                    <img alt='' src='../../../images/business/newCustomerActivities/cont_1.png' />
                    <div class='welcome_cont'>
                        ...
                        <p class='welcome_text pointer'>
                            Step 2: Follow
                            <a class='link' href='https://www.facebook.com/MagnaMarkets/' target='_blank'>
                        ...
                        <p class='welcome_text pointer'>
                            Step 4: Follow
                            <a class='link' href='https://twitter.com/MagnaMarkets_' target='_blank'>
                        ...
                        <p class='welcome_text pointer'>
                            Step 5:
                            <a class='link' href='https://twitter.com/MagnaMarkets_/status/1552551420070469632?s=20&t=vN-kLx3P6RfpFOeekgvFgA' target='_blank'>
                ...
                <div class='welcome'>
                    <img alt='' src='../../../images/business/newCustomerActivities/cont_2.png' />
                    <div class='welcome_cont'>
                        <p class='welcome_title'>
                            Welcome 2
                        </p>
                ...
                <div class='welcome'>
                    <img alt='' src='../../../images/business/newCustomerActivities/cont_3.png' />
                    <div class='welcome_cont'>
                        <p class='welcome_title'>
                            Welcome 3
                        </p>
...
.actives {
    ...
    .cont_bg {
        background-image: url('../../../images/business/newCustomerActivities/bg.png');
