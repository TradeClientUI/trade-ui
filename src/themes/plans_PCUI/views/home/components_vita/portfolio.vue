            ...
            <div class='flex'>
                ...
                <div class='content'>
                    <div class='btn-wrap'>
                        ...
                        <a class='btn' :href="downloads['google']">
                            <svg class='icon-svg' fill='none' viewBox='0 0 1024 1024' xmlns='http://www.w3.org/2000/svg'>
                                <path d='M708.266667 669.866667l213.333333-123.733334c8.533333-4.266667 17.066667-17.066667 17.066667-25.6v-12.8c0-12.8-4.266667-21.333333-17.066667-25.6l-213.333333-123.733333-140.8 153.6 140.8 157.866667z m-174.933334-196.266667l128-145.066667L187.733333 46.933333c-8.533333-4.266667-17.066667-4.266667-25.6 0l371.2 426.666667z m0 81.066667L162.133333 981.333333c8.533333 4.266667 17.066667 4.266667 25.6 0l473.6-277.333333-128-149.333333zM128 89.6v844.8l371.2-422.4L128 89.6z' />
                            </svg>
                            <span>{{ $t('download.google') }}</span>
                        </a>
                    </div>
                    <div class='qr-code'>
                        <div class='code-img'>
...
.portfolio{
    ...
    .row{
        ...
        .icon1{
            background-image: url('../../../images/home/portfolio-icon1.jpg');
        }
        .icon2{
            background-image: url('../../../images/home/portfolio-icon2.jpg');
        }
        .icon3{
            background-image: url('../../../images/home/portfolio-icon3.jpg');
        }
    }
    .title{
        padding-bottom: 15px;
