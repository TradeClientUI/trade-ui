<template>
    <centerViewDialog>
        <div class='pageWrap'>
            ...
            <div class='wrap'>
                ...
                <div class='bank-wrap'>
                    ...
                    <div v-else class='bank no-data pc_add_bankcard_ga' @click='openSheet'>
        ...
        <van-button block class='confirm-btn pc_withdraw_confirm_ga' type='primary' @click='confirm'>
            <span>{{ $t('withdraw.confirm') }}</span>
        </van-button>
    </centerViewDialog>

    <!-- 选择银行卡弹窗 -->
    <van-dialog v-model:show='show' class='select-bank-dialog' :round='false' :title="$t('withdrawMoney.bankPopupTitle')">
        <div class='bank-list'>
            <div
